...
INSERT INTO invoise (ORDER_NUMBER,ID_CUSTOMER) VALUES
...
INSERT INTO invoice_line (ID_PRODUCT,QUANTITY,INVOICE_NUMBER) VALUES
  ((select ID from  product where NAME='Picnic Forks'),10,(select INVOICE_NUMBER from invoise where ORDER_NUMBER='AA123456789A')),
  ((select ID from product where NAME='Autonomous Lawn Mower'),1,(select INVOICE_NUMBER from invoise where ORDER_NUMBER='AA123456789A')),
  ((select ID from product where NAME='Smartphone'),1,(select INVOICE_NUMBER from invoise where ORDER_NUMBER='AA123456789B')),
  ((select ID from product where NAME='Picnic Forks'),22,(select INVOICE_NUMBER from invoise where ORDER_NUMBER='BB123456789A')),
  ((select ID from product where NAME='Mirror'),2,(select INVOICE_NUMBER from invoise where ORDER_NUMBER='BB123456789A')),
  ((select ID from product where NAME='Picnic Forks'),5,(select INVOICE_NUMBER from invoise where ORDER_NUMBER IS NULL));